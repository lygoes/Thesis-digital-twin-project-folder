...
setInterval(() => {
console.log('testing', DataBboxespilesEmissions[0].WorkingTime) 
}, 5000);
...
class AppearObjects extends BaseExtension {
    ...
    async onModelLoaded(model) {
        ...
        // this.viewer.hide([10740, 10677]) //it should hide only machines that are not active on site e.g. with no data
        // this.viewer.hide([3690, 3691, 3692, 3693, 3694, 3695, 3696, 3697, 3720, 3721, 3722, 3723, 3724, 3725, 3726])
        this.viewer.hide(3563) //structural viga
        //can also make machines disappear
        this.viewer.hide(ListPilesDbIds)
        // setTimeout(() =>  { 
        // this.viewer.show([3690, 3691, 3692, 3693, 3694, 3695, 3696, 3697, 3720, 3721, 3722, 3723, 3724, 3725, 3726])
        // },10000)
        setTimeout(() => { //Set interval if wants to be updating
            // const dataarray =  [5,6,4]
